...
export function createApp(dependencies: DepsContainer): Express {
  ...
  publicRouter.get(
    "/health",
    constructMiddlewareWrapper(
      buckets.healthCheckTokenBucket,
      "ip",
      "h:health",
    ),
    (req, res) => {
  ...
  publicRouter.get(
    "/metrics",
    constructMiddlewareWrapper(
      buckets.metricsCheckTokenBucket,
      "ip",
      "m:metrics",
    ),
    async (req, res) => {
  ...
  publicRouter.post(
    ...
    constructMiddlewareWrapper(
      buckets.registerConfirmTokenBucket,
      "email+ip",
      "rl:register-confirm",
    ),
  ...
  publicRouter.post(
    ...
    constructMiddlewareWrapper(
      buckets.passwordResetTokenBucket,
      "email+ip",
      "rl:pw-reset",
    ),
  ...
  publicRouter.post(
    ...
    constructMiddlewareWrapper(
      buckets.passwordResetConfirmTokenBucket,
      "email+ip",
      "rl:pw-reset-confirm",
    ),
  ...
  privateRouter.patch(
    ...
    dependencies.controllerChangePassword.changePasswordCont,
  );
  privateRouter.patch(
    "/user/name",
    validateBody(UpdateNameBodySchema),
    dependencies.controllerUpdateName.updateNameCont,
  );
  privateRouter.post(
    "/user/email-change",
    validateBody(RequestEmailChangeBodySchema),
    dependencies.controllerRequestEmailChange.requestEmailChangeCont,
  );
  privateRouter.post(
    "/user/email-change/confirm",
    validateBody(ConfirmEmailChangeBodySchema),
    dependencies.controllerConfirmEmailChange.confirmEmailChangeCont,
  );
  privateRouter.post(
    "/user/account-deletion",
    dependencies.controllerRequestAccountDeletion.requestAccountDeletionCont,
  );
  privateRouter.post(
    "/user/account-deletion/confirm",
    validateBody(ConfirmAccountDeletionBodySchema),
    dependencies.controllerConfirmAccountDeletion.confirmAccountDeletionCont,
  );

  privateRouter.get(
    "/user/me",
    dependencies.controllerGetSelfProfile.getSelfProfileCont,
  );
  privateRouter.get(
    "/user/:targetId",
    dependencies.controllerGetOtherProfile.getOtherProfileCont,
  );

  // connection routes
  privateRouter.post(
    "/connections",
    validateBody(CreateConnectionBodySchema),
    dependencies.controllerConnectionCreate.createConnectionCont,
  );
  privateRouter.get(
    "/connections",
    dependencies.controllerConnectionListActive.listActiveConnectionsCont,
  );
  privateRouter.get(
    "/connections/deleted",
    dependencies.controllerConnectionListDeleted.listDeletedConnectionsCont,
  );
  privateRouter.patch(
    "/connections/:id",
    validateBody(UpdateConnectionBodySchema),
    dependencies.controllerConnectionUpdate.updateConnectionCont,
  );
  privateRouter.delete(
    "/connections/:id",
    dependencies.controllerConnectionSoftDelete.softDeleteConnectionCont,
  );
  privateRouter.post(
    "/connections/:id/restore",
    dependencies.controllerConnectionRestore.restoreConnectionCont,
  );

  // github source routes
  privateRouter.post(
    "/github-sources",
    validateBody(CreateGithubSourceBodySchema),
    dependencies.controllerGithubSourceCreate.createSourceCont,
  );
  privateRouter.get(
    "/github-sources",
    dependencies.controllerGithubSourceList.listSourcesCont,
  );
  privateRouter.delete(
    "/github-sources/:id",
    dependencies.controllerGithubSourceDelete.deleteSourceCont,
  );
  ...
  privateRouter.post(
    ...
    dependencies.controllerSubscriptionCreate.createSubscriptionCont,
  );
  privateRouter.get(
    "/subscriptions",
    dependencies.controllerSubscriptionList.listSubscriptionsCont,
  );
  privateRouter.delete(
    "/subscriptions/:id",
    dependencies.controllerSubscriptionDelete.deleteSubscriptionCont,
  );

  // report routes
  privateRouter.post(
    "/report-configs",
    validateBody(CreateReportConfigBodySchema),
    dependencies.controllerReportConfigCreate.createReportConfigCont,
  );
  privateRouter.get(
    "/report-configs",
    dependencies.controllerReportConfigList.listReportConfigsCont,
  );
  privateRouter.delete(
    "/report-configs/:id",
    dependencies.controllerReportConfigDelete.deleteReportConfigCont,
  );
  privateRouter.post(
    "/reports/generate",
    validateBody(GenerateReportBodySchema),
    dependencies.controllerReportGenerate.generateReportCont,
  );
